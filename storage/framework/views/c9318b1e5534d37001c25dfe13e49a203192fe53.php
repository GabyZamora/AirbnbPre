            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item"> 
                            <a class="nav-link" href="<?php echo e(route('catalogo.index')); ?>"><?php echo e(__('Lugares')); ?></a>
                        </li>
                    </ul>
                    <?php endif; ?>
...
<?php /**PATH C:\laragon\www\AirbnbTesina\resources\views/layouts/app.blade.php ENDPATH**/ ?>